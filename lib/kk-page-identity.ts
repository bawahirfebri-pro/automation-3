...
export async function extractKkPageIdentity(
  ...
  for (
    ...
    try {
      console.log(
        `[KK Page Identity] ${file.name} → ${modelName}`
      );
