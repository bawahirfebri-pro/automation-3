...
export default function AktaPanel({ data, modelUsed, isLoading = false }: AktaPanelProps) {
  if (isLoading) {
    return (
      <section className="col-span-12 lg:col-span-6">
        <div className="flex min-h-[408px] items-center justify-center rounded-2xl border border-gray-200 bg-white">
          <div className="flex flex-col items-center px-6 text-center">
            ...
            <p className="text-sm font-semibold text-gray-700">Memuat data Akta Kelahiran</p>
      ...
      <section className="col-span-12 lg:col-span-6">
        <div className="flex min-h-[408px] items-center justify-center rounded-2xl border border-dashed border-gray-200 bg-white">
          <div className="px-6 text-center">
            ...
            <p className="text-sm font-medium text-gray-600">Akta belum diekstrak</p>
