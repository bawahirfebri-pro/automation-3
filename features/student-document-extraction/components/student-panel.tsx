...
function getDetectedActionStatus(
  kkStatus: DocumentStatus,
  aktaStatus: DocumentStatus,
...
export default function StudentPanel({
  ...
  const visibleStudents =
    hasMultipleDetected && activeTab === "detected" ? detectedStudents : filteredAllStudents;
  ...
  const hasFilter =
    Boolean(search) || Boolean(selectedKelas) || Boolean(selectedRombel) || Boolean(selectedStatus);
          ...
          <div className="flex shrink-0 items-center gap-2">
            {canSaveAll && (
              ...
              >
                ...
                {savingAll
                  ? "Menyimpan..."
                  : `Simpan Semua (${detectedStudentsReadyToSave.length})`}
              </button>
            )}
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className={`relative px-3 pb-2.5 text-xs font-medium transition-colors ${
                  activeTab === "detected" ? "text-blue-600" : "text-gray-400 hover:text-gray-700"
                }`}
              >
                Terdeteksi
                <span
              ...
              <button
                ...
                className={`relative px-3 pb-2.5 text-xs font-medium transition-colors ${
                  activeTab === "all" ? "text-blue-600" : "text-gray-400 hover:text-gray-700"
                }`}
              >
                Semua Murid
                {activeTab === "all" && (
            ...
            <div className="flex items-center gap-2">
              <div className="relative min-w-0 flex-1">
                ...
                <input
                  ...
                  className="h-9 w-full rounded-lg border border-gray-200 bg-gray-50/70 pr-3 pl-9 text-xs text-gray-700 transition outline-none focus:border-gray-300 focus:bg-white"
                />
              </div>
              ...
              <div className="relative w-[92px] shrink-0">
                <select
                  ...
                  className={`h-9 w-full appearance-none rounded-lg border pr-8 pl-3 text-xs font-medium transition outline-none ${selectedKelas ? "border-gray-300 bg-gray-100 text-gray-800" : "border-gray-200 bg-white text-gray-500 hover:bg-gray-50"}`}
                >
              ...
              <div className="relative w-[92px] shrink-0">
                <select
                  ...
                  className={`h-9 w-full appearance-none rounded-lg border pr-8 pl-3 text-xs font-medium transition outline-none ${selectedRombel ? "border-gray-300 bg-gray-100 text-gray-800" : "border-gray-200 bg-white text-gray-500 hover:bg-gray-50"}`}
                >
              ...
              <div className="relative w-[124px] shrink-0">
                <select
                  ...
                  className={`h-9 w-full appearance-none rounded-lg border pr-8 pl-3 text-xs font-medium transition outline-none ${selectedStatus ? "border-gray-300 bg-gray-100 text-gray-800" : "border-gray-200 bg-white text-gray-500 hover:bg-gray-50"}`}
                >
        ...
        {loading && students.length === 0 ? (
          <div className="flex flex-1 items-center justify-center px-6 text-center">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400">Memuat data murid.</p>
            </div>
          </div>
            ...
            <ul>
              {visibleStudents.map((student) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`relative flex items-center justify-between gap-4 border-b border-gray-100 px-5 py-3.5 transition-colors ${
                        isActive
                          ? "bg-blue-50/60"
                    ...
                    >
                      ...
                      <div className="flex shrink-0 items-center gap-1.5">
                        {showingDetectedTab && (
                          <span
                            className={`mr-1 rounded-full px-2.5 py-1 text-[9px] font-semibold ${getDetectedActionClass(actionStatus)}`}
                          >
                        ...
                        {feedback === "error" && (
                          <span className="ml-1 text-[10px] font-medium text-red-500">Gagal</span>
                        )}
                      </div>
                    </div>
                  </li>
